...
from GEM.utils.comm import is_main_process
from GEM.utils.comm import synchronize
from GEM.utils.models.policy.GEM_Policy import GEM_policy
...
def make_policy(policy_class, cfg):
    if policy_class == 'GEM':
        policy = GEM_policy(cfg)
    else:
        raise NotImplementedError

    return policy

def load_policy_and_stats(ckpt_path, policy_class, cfg):
